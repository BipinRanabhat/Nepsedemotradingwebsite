      ...
      <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:support@nepsedemotrade.com" className="text-emerald-600 underline">support@nepsedemotrade.com</a>{" "}
            if you suspect unauthorized access to your account.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">5. Virtual Currency and Trading</h2>
          <p>
            Upon registration, you are granted a virtual starting balance (denominated in virtual NPR) for use within the App. This virtual currency:
          </p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">7. Not Financial Advice</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">8. Accuracy of Market Data</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">12. Changes to Terms</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-bold text-gray-800 mb-3">13. Governing Law</h2>
          <p>
